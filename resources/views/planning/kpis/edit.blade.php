...
<div class="container mx-auto px-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a class="inline-flex items-center gap-2 rounded-2xl border border-slate-700/60 px-4 py-2 text-xs sm:text-sm font-semibold text-slate-300 transition hover:border-slate-500 hover:text-slate-100"
                href="{{ route('planning.objectives.show', [$objective->plan,$objective->id]) }}">Volver
                al objetivo</a>
        </div>
    </div>
    ...
    <form
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit"
                class="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-sky-500 via-indigo-500 to-fuchsia-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/40 transition hover:-translate-y-0.5">Actualizar
                KPI</button>
        </div>
    </form>
</div>
