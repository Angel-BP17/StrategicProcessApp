...
<div class="container mx-auto px-0 sm:px-4">
    ...
    <form action="{{ route('documents.index') }}" method="GET"
        ...
        <label class="relative block">
            ...
            <input type="search" name="q" value="{{ $filters['q'] }}" placeholder="Buscar por título o descripción"
        ...
        <table class="w-full text-xs sm:text-sm">
            <thead>
                <tr class="bg-slate-900/80 text-slate-300 uppercase tracking-wide text-[11px] sm:text-xs">
                    ...
                    <th class="px-4 py-3 text-left font-semibold">Última Versión</th>
            ...
            <tbody class="divide-y divide-slate-800/70">
                ...
                <tr class="hover:bg-slate-900/60 transition">
                    ...
                    @php $creator = \app\models\User::where('id',$document->created_by)->first() @endphp
                    <td class="px-4 py-4 text-slate-300">
                        {{ $creator->full_name ?? '—' }}
                    </td>
