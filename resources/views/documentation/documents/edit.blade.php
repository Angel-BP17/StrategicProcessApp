    ...
    <div class="container mx-auto px-0 sm:px-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            <div>
                ...
                <h1 class="text-3xl font-semibold text-slate-100">Editar documento</h1>
                <p class="text-sm text-slate-400 mt-1">Actualiza la metadata del documento para mantenerla vigente.</p>
            </div>
        ...
        @include('documentation.documents._form', [
            ...
            'statuses' => $statuses,
            'submitLabel' => 'Actualizar documento',
