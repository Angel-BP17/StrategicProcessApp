                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required
                                class="block w-full bg-slate-800/60 border border-slate-700 text-slate-100 rounded-lg shadow-sm py-2 px-3 focus:border-sky-500 focus:ring focus:ring-sky-500 focus:ring-opacity-50 text-sm">
                            <option value="internal" {{ old('type', $audit->type) == 'internal' ? 'selected' : '' }}>Interna</option>
                            <option value="external" {{ old('type', $audit->type) == 'external' ? 'selected' : '' }}>Externa</option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="objective" id="objective" value="{{ old('objective', $audit->objective) }}" required
                               class="block w-full bg-slate-800/60 border border-slate-700 text-slate-100 rounded-lg shadow-sm py-2 px-3 focus:border-sky-500 focus:ring focus:ring-sky-500 focus:ring-opacity-50 text-sm">
                        @error('objective') <p class="mt-1 text-xs text-red-400">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @error('range') <p class="mt-1 text-xs text-red-400">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $audit->start_date) }}" required
                               class="block w-full bg-slate-800/60 border border-slate-700 text-slate-100 rounded-lg shadow-sm py-2 px-3 focus:border-sky-500 focus:ring focus:ring-sky-500 focus:ring-opacity-50 text-sm">
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $audit->end_date) }}" required
                               class="block w-full bg-slate-800/60 border border-slate-700 text-slate-100 rounded-lg shadow-sm py-2 px-3 focus:border-sky-500 focus:ring focus:ring-sky-500 focus:ring-opacity-50 text-sm">
                    ...
                    <div>
                        ...
                        <select name="state" id="state" required
                                class="block w-full bg-slate-800/60 border border-slate-700 text-slate-100 rounded-lg shadow-sm py-2 px-3 focus:border-sky-500 focus:ring focus:ring-sky-500 focus:ring-opacity-50 text-sm">
                            <option value="planned" {{ old('state', $audit->state) == 'planned' ? 'selected' : '' }}>Planificada</option>
                            <option value="in_progress" {{ old('state', $audit->state) == 'in_progress' ? 'selected' : '' }}>En Progreso</option>
                            <option value="completed" {{ old('state', $audit->state) == 'completed' ? 'selected' : '' }}>Completada</option>
                            <option value="cancelled" {{ old('state', $audit->state) == 'cancelled' ? 'selected' : '' }}>Cancelada</option>
                        </select>
