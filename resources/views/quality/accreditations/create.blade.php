...
@section('title', 'Registrar Nueva Acreditación')
...
@section('content')
    ...
    <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 text-slate-100">
        ...
        <div class="mb-8">
             ...
             <h1 class="text-3xl font-semibold">Registrar Nueva Acreditación</h1>
         </div>
        ...
        <div class="bg-slate-950/60 border border-slate-800/70 shadow-xl shadow-slate-900/50 rounded-2xl mb-10 overflow-hidden">
            ...
            {{-- Formulario --}}
            <form action="{{ route('quality.accreditations.store') }}" method="POST" class="p-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    {{-- Campo: Resultado --}}
                    <div class="md:col-span-2">
                        <label for="result" class="block text-sm font-semibold text-slate-300 mb-1">Resultado (Ej. "Aprobado", "Certificación ISO 9001")</label>
