    ...
    <div class="max-w-5xl mx-auto px-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 text-slate-100">
            <div>
                ...
                <h1 class="text-3xl font-semibold">Registrar nuevo socio</h1>
                <p class="text-sm text-slate-400">Captura la información esencial de un nuevo aliado institucional.</p>
            </div>
        ...
        <form action="{{ route('partners.store') }}" method="POST"
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="submit"
                    class="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/30 transition hover:-translate-y-0.5">Guardar socio</button>
            </div>
        </form>
    </div>
@endsection
