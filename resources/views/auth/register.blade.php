        ...
        <div class="bg-[#201A2F] rounded-2xl shadow-2xl p-8 border border-[#26BBFF]/10">
            ...
            @if ($errors->any())
                <div class="mb-6 bg-red-500/10 border border-red-500/50 rounded-lg p-4">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <h3 class="text-sm font-semibold text-red-400 mb-1">Por favor corrige los siguientes errores:</h3>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-[#848282]">
                    ...
                    <a href="{{ route('login') }}" class="text-[#26BBFF] hover:text-[#26BBFF]/80 font-semibold transition-colors duration-200">
                        Inicia sesión
                    </a>
                </p>
            </div>
