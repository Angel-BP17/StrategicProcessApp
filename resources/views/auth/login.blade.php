        ...
        <div class="bg-[#201A2F] rounded-2xl shadow-2xl p-8 border border-[#26BBFF]/10">
            ...
            @if (session('success'))
                <div class="mb-6 bg-[#26BBFF]/10 border border-[#26BBFF]/50 rounded-lg p-4">
                    <div class="flex items-start">
                        <svg class="w-5 h-5 text-[#26BBFF] mt-0.5 mr-3 flex-shrink-0" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                            class="text-sm text-[#26BBFF] hover:text-[#26BBFF]/80 transition-colors duration-200">
