...
<body class="bg-[#111115] min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="px-4 py-2 text-sm font-semibold text-white hover:text-[#26BBFF] transition-colors duration-200">
                            Iniciar Sesión
                        </a>
                        <a href="{{ route('register') }}"
                            class="px-6 py-2 text-sm font-bold text-[#111115] bg-[#26BBFF] rounded-lg hover:bg-[#26BBFF]/90 transition-all duration-200 transform hover:scale-105">
                            Registrarse
                        </a>
                    @endauth
                </div>
    ...
    <div class="relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center">
                <!-- Badge -->
                <div
                    class="inline-flex items-center px-4 py-2 bg-[#201A2F] border border-[#26BBFF]/30 rounded-full mb-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center relative z-10">
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="px-8 py-4 bg-[#26BBFF] text-white font-bold rounded-lg hover:bg-[#26BBFF]/90 transition-all duration-200 transform hover:scale-105 shadow-lg shadow-[#26BBFF]/20 ring-1 ring-[#26BBFF]/20">
                            Ir al Dashboard
                        </a>
                    @else
                        <a href="{{ route('register') }}"
                        ...
                        <a href="{{ route('login') }}"
                            class="px-8 py-4 bg-[#201A2F] text-white font-semibold rounded-lg border border-[#848282]/30 hover:border-[#26BBFF] transition-all duration-200 shadow-sm">
                            Iniciar Sesión
                        </a>
                    @endauth
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <!-- Feature 1 -->
            <div
                class="bg-[#201A2F] border border-[#848282]/20 rounded-2xl p-8 hover:border-[#26BBFF]/50 transition-all duration-300 group">
                <div
                    class="w-12 h-12 bg-[#26BBFF]/10 rounded-lg flex items-center justify-center mb-6 group-hover:bg-[#26BBFF]/20 transition-colors duration-300">
